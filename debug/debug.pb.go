...
func file_github_com_openconfig_gnoi_debug_debug_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_openconfig_gnoi_debug_debug_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_openconfig_gnoi_debug_debug_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_openconfig_gnoi_debug_debug_proto_msgTypes[2].Exporter = func(v any, i int) any {
